...
*한계값*은 현재 ~~17cm~~ ~~7cm~~ ~~8cm~~ 5cm로 개발하고 있습니다. 시연을 위해 점차 한계값을 줄여나갈 계획입니다.<br>
...
**2024 / 11 / 11**<br>
한계값 적응을 시킴.<br>
전체 반복문의 (한계값 + 1)을 (한계값 + 0.5)로 수정<br>
#### Issue
> 한계값이 5cm 이하로는 잘 작동하지 않는 것을 확인. 원인은?
